...
class StringWidget implements Widget {
	...
	<div class="col-sm-10">
		<input type="text" class="form-control" name="'.$this->fieldName.'" id="'.$this->fieldName.'" value="'.\htmlentities($this->currentValue).'" '.$readOnly.' aria-describedby="'.$this->fieldName.'-help">
