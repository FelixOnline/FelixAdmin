...
class Uploader implements Widget {
	private $fieldName;
	private $label;
	...
	<div class="col-sm-10">
		<input type="file" class="form-control" name="'.$this->fieldName.'" id="'.$this->fieldName.'" '.$readOnly.' aria-describedby="'.$this->fieldName.'-help">
